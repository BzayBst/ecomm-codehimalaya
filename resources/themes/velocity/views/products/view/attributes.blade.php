                ...
                <table class="full-specifications">
                    ...
                    @foreach ($customAttributeValues as $attribute)
                        <tr>
                            ...
                            <!-- @elseif ($attribute['type'] == 'checkbox' && $attribute['value'])
                                 <td>
                                <select name="{{ $attribute['label'] }}" id="{{ $attribute['label'] }}" class="form-control">
                                     <option>Select {{ $attribute['label'] }} </option>
                                 ...
                                 @elseif ($attribute['type'] == 'select' && $attribute['value'])
                                 <td>
                                <select name="{{ $attribute['label'] }}" id="{{ $attribute['label'] }}" class="form-control">
                                        <option>Select {{ $attribute['label'] }} </option>
                                      @foreach (explode(',', $attribute['value']) as $value)
